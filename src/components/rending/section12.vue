        ...
        <div class="item_box">
          ...
          <div class="item" @click="$router.push('/Bag/detail/19')">
            ...
            <div class="info_box">
              ...
              <p class="text">디올 숄더 스트랩 파우치 베이지 & 블랙 디올 오블리크 자카드</p>
            </div>
          </div>
          <div class="item" @click="$router.push('/Bag/detail/41')">
            ...
            <div class="info_box">
              <p class="title">Dior</p>
              <p class="text">디올 새들백 베이지 & 블랙 디올 오블리크 자카드</p>
            </div>
          </div>
          <div class="item" @click="$router.push('/Bag/detail/16')">
            ...
            <div class="info_box">
              ...
              <p class="text">샤넬 스몰 백팩 그레인드 샤이니 카프스킨 & 골드 메탈 블랙</p>
            </div>
          </div>
          <div class="item" @click="$router.push('/Bag/detail/2')">
            <img src="/media/products/bag/2/mainImg.png">
            <div class="info_box">
              <p class="title">Hermes Birkin30 Etoupe Gold</p>
              <p class="text">에르메스 벌킨30 에토프 금장</p>
            </div>
          </div>
        </div>
      </div>
      <div class="btn_box">
        <button @click="$router.push('/product/Bag')">
          더보기
        </button>
      </div>
    </div>
