<template>
  <div class="product_category" id="Top_View">
    <div class="pc_container">
      ...
      <div class="product_item_container">
        ...
        <div class="product_main">
          <div @click="$router.push(`/top/detail/${i.id}`)" class="product_list" v-for="i in pagedItems" :key="i.id">
            <img :src="i.img">
...
<script>
  import ITEM from '../../constants/top_item'
  export default {
    name: "Top_View",
    data() {
      return {
